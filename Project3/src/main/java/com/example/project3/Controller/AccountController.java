...
public class AccountController {
    ...
    public ResponseEntity getAllAccounts(@AuthenticationPrincipal Employee employee){
    ...
    public ResponseEntity getMyAccounts(@AuthenticationPrincipal Customer customer){
    ...
    @PostMapping("add")
    public ResponseEntity addAccount (@AuthenticationPrincipal Customer customer, @Valid @RequestBody Account account){
    ...
    public ResponseEntity withdraw(@AuthenticationPrincipal Customer customer ,@PathVariable Integer accountId , @PathVariable Integer amount ){
    ...
    public ResponseEntity deposit(@AuthenticationPrincipal Customer customer ,@PathVariable Integer accountId , @PathVariable Integer amount ){
    ...
    public ResponseEntity transferFunds(@AuthenticationPrincipal Customer customer ,@PathVariable Integer accountId ,@PathVariable Integer accountId2 , @PathVariable Integer amount ){
